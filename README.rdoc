...
* rbmediawiki gem (gem install rbmediawiki)
* sqlite3 with headers ("sudo apt-get install libsqlite3-dev" on ubuntu)
* sqlite3-ruby (gem install sqlite3-ruby) Don't install sqlite3, install sqlite3-ruby instead (http://stackoverflow.com/questions/1797199/uninitialized-constant-encoding-with-sqlite3-ruby-on-windows)
...
* r18n-desktop (gem install r18n-desktop)
